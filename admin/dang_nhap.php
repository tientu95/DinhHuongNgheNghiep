                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="dang_nhap_kiem_tra.php">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="email" required placeholder="name@example.com" name="txtEmail" />
                                                <label for="inputEmail">Địa chỉ Email</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPassword" type="password" required placeholder="Password" name="txtMatKhau" />
