...
<html lang="en">
    <head>
        ...
        <title>Thêm mới chuyên ngành</title>
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div style="background-image: repeating-radial-gradient(0,#179EA1, #1a2936); color: #fff;" class="card-header">
                                        <h3 class="text-center font-weight-light my-4">Thêm mới chuyên ngành</h3>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="chuyen_nganh_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Tên chuyên ngành" name="txtTen_chuyen_nganh" />
                                                <label for="inputEmail">Tên chuyên ngành</label>
                                            </div>
                                            <div class="form-floating mb-3">
