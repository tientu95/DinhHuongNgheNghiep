            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Quản trị ngành đào tạo</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Quản trị ngành đào tạo</li>
                        </ol>
                        <div class="card mb-4">
                        <div class="card-header" style = "display: flex; justify-content: space-between;">
                                ...
                                <div style="height: 36px; background-image: repeating-radial-gradient(0,#179EA1, #1a2936);">
                                    <a style="color: white; text-decoration: none; line-height: 36px; padding: 0 6px; font-weight: 500;" href="nganh_dt_them_moi.php">Thêm mới</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <td><?php echo $row["mo_ta_nganh_dt"];?></td>
                                            <td style="display: flex; justify-content: space-around;" >
                                                <a class="btn btn-success"  href="nganh_dt_sua.php?id=<?php echo $row["id_nganh_dt"];?>">Sửa</a>
                                                <a class="btn btn-danger"  href="nganh_dt_xoa.php?id=<?php echo $row["id_nganh_dt"];?>">Xóa</a>    
                                            </td>
                                            </tr>
                                    <?php
                                        }
