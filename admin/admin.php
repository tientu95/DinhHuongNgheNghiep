                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Quản trị admin</h1>
                            <p class="breadcrumb-item active">Quản trị admin</p>
                        <div class="card mb-4">
                        <div class="card-header" style = "display: flex; justify-content: space-between;">
                                ...
                                <div style="height: 36px; background-image: repeating-radial-gradient(0,#179EA1, #1a2936);">
                                    <a style="color: white; text-decoration: none; line-height: 36px; padding: 0 6px; font-weight: 500;" href="admin_them_moi.php">Thêm mới</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <td style="display: flex; justify-content: space-around;" >
                                                <a class="btn btn-danger"  href="admin_xoa.php?id=<?php echo $row["id_admin"];?>">Xóa</a>    
                                            </td>
                                            </tr>
                                    <?php
                                        }
