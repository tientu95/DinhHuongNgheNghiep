                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="admin_sua_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Tên admin" name="txtTen_admin" value="<?php echo $row["ten_admin"];?>" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Password" name="txtPass" value="<?php echo $row["password"];?>" />
