    ...
    <body class="sb-nav-fixed">
        <?php 
            ...
            $noi_dung = $_POST['txtNoidung'];
                ...
                $sql = " INSERT INTO `tbl_nghe_nghiep` (`id_nghe_nghiep`, `id_chuyen_nganh`, `ten_nghe_nghiep`, `mo_ta_nghe`, `noi_dung`) VALUES (NULL, '".$id_chuyen_nganh."', '".$ten_nghe_nghiep."', '".$mo_ta_nghe."', '".$noi_dung."');    
