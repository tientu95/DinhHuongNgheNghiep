                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                ...
                                <div style="background-image: repeating-radial-gradient(0,#179EA1, #1a2936); color: #fff;" class="card-header">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="nghe_nghiep_sua_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Tên nghề" name="txtten_nghe_nghiep" value="<?php echo $row["ten_nghe_nghiep"];?>" />
                                                <label for="inputEmail">Tên nghề</label>
                                            </div>
                                             <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <textarea placeholder="Mô tả" name="txtMoTa" id="txtMoTa"><?php echo $row["mo_ta_nghe"];?></textarea>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <input type="hidden" name="txtID" value="<?php echo $row["id_nghe_nghiep"];?>">
